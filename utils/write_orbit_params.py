...
def generate_orbit_params(rp_newton, inc_parabola,output_dir):
        output_file = f'{output_dir}/orbit.params'
...
if __name__ == "__main__":
    ...
    generate_orbit_params(rp_newton, inc_parabola, output_file)
